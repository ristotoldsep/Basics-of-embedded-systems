...
// write this function
	...
	}while(AS == 0x10);//switch is on/pressed
...
// write this function
	do{
				AS = GPIO_PORTF_DATA_R&0x10;
	}while(AS == 0x00);//switch is off/released
}
...
void ClearVT(void){
// write this function
		GPIO_PORTF_DATA_R &= ~0x02;  //Inverteerib biti
}
...
// write this function
  ...
  while(msec > 0){
    ...
    i = 13333;  // this number means 1ms in 80MHz clock  => 0.001s/(1/80000000)/6
